...
<!-- This Template is included in htdocs/templates/contactMain.tpl -->
<!-- css-Files and other stuff is included by contactMain.tpl -->
<!-- contactMain.tpl is called bei src/exercises/using-templates/contact.php in the constructor of the class -->
<!-- htdocs/contact.php requires src/exercises/using-templates/contact.php, that is requested by the Browser -->

<!-- TODO Have a look at the form in htdocs/templates/normFormDemo.tpl -->
